...
It has been an exciting quarter for supply chain security and SLSA, with the release of the [SLSA v1.0 specification](/blog/2023/04/slsa-v1-final), [SLSA provenance support for npm](https://github.blog/2023-04-19-introducing-npm-package-provenance/), and the announcement of new SLSA Level 3 builders for [Node.js](/blog/2023/05/bringing-improved-supply-chain-security-to-the-nodejs-ecosystem) and [containers](/blog/2023/06/slsa-github-workflows-container-based)!

SLSA already provides and maintains official builders for [Go](/blog/2022/06/slsa-github-workflows), [Node.js](/blog/2023/05/bringing-improved-supply-chain-security-to-the-nodejs-ecosystem) and [Container](/blog/2023/06/slsa-github-workflows-container-based) based projects. But what if you don't use any of these languages or use custom tooling that isn't supported by the official builders?
