...
-   Build-time SBOM generated by the build tool, capturing direct and transitive dependencies for the artifact being released.
...
-   Comprehensive picture of all third party dependencies enables understanding of the risk exposure
-   An inventory is a prerequisite for known vulnerability management
