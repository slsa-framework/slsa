...
| Branch | A named pointer to a revision where the revision pointed to changes over time. Branches may be modified by authorized actors. Different branches may have different security requirements.
