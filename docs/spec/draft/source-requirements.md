...
| Branch | A named, moveable, pointer to a revision. Branches may be modified to point to new revisions by authorized actors. Different branches may have different security requirements.
