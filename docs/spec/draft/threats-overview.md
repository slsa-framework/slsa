...
**Source integrity:** Ensure that the Source Revision represents the intent of the producer, that all expected processes were followed and that the Source Revision was not modified after being accepted.
