...
Vulnerabilities to the supply chain threatens source code integrity and the security of an entire software system. This complex problem is covered in the following two pages of this section:

- [Introduction to supply chain attacks:](introduction-to-supply-chain-attacks) with examples of real-world threats, how to they relate to the supply chain, and what SLSA can do to mitigate them.

- [Threats & Mitigation:](threats.md) with examples that go into greater detail of each threat, showing how SLSA can be used to protect the integrity of the supply chain and make your software more secure. 
