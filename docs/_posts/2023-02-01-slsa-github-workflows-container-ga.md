...
Today, we are announcing the general availability of the [SLSA 3 Container Generator for GitHub Actions](https://github.com/slsa-framework/slsa-github-generator/tree/main/internal/builders/container) starting with v1.4.0. This free tool allows any GitHub project to produce SLSA level 3 compliant provenance statements so users can verify the origin of container images they use. With the Container Generator these provenance statements can be distributed alongside your images in a container registry and integrate directly with [Sigstore](https://www.sigstore.dev/)-compatible tooling for inspection and verification.
