...
Track Levels 1-3](/spec/v1.0/levels#build-track) roughly
correspond to
[Levels 1-3 of v0.1](/spec/v0.1/requirements#build-requirements),
...
currently have [plans](/spec/v1.0/future-directions) for Build
Level 4 and a Source Track. 

The v1.0 RC also defines the [principles](/spec/v1.0/principles)
...
**[Producing artifacts](/spec/v1.0/requirements)** explains
